...
public class BillCollectionEntity {
    ...
    public BillCollectionEntity() {
    }

    public BillCollectionEntity(String BILL_NO, String BUNDLE_NO, String BANK_CODE, String SCROLL_NO, String PAID, String COLLECTED_VAT, String c_TARIFF) {
        this.id = id;
    ...
    public String toString() {
        return "BillCollectionEntity{" +
                ...
                ", BILL_TRANSACTIONID='" + BILL_TRANSACTIONID + '\'' +
                '}';
    }
}
